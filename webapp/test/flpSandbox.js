		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtolaramappppzppcartoncreat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtolaramappppzppcartoncreat-display": {
								"semanticObject": "comtolaramappppzppcartoncreat",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tolaram.app.pp.zppcartoncreat",
									"url": sap.ui.require.toUrl("com/tolaram/app/pp/zppcartoncreat")
								}
							}
						}
					}
